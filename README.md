# Mncrft
A slightly Minecraft-themed strategy game about chopping trees, creating houses, recruiting villagers, defeating zombies, and hiding in aforementioned houses from aforementioned zombies with aforementioned villagers written in VB.NET 4.5.
